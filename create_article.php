...
require_once "config/dadabase.php";
session_start();
...
<head>
    ...
    <link rel="stylesheet" href="style/sidebare.css">
...
<aside class="sidebar">
    ...
    <div class="sidebar-footer">
        ...
        <form action="/action/create_article_action.php" method="POST" enctype="multipart/form-data">
